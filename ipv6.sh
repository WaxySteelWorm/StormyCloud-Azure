...
location="East US"
resourceGroup="tor-bridge-$randomIdentifier"
ipV4PublicIp="tor-bridge-ipV4-public-ip-address-$randomIdentifier"
ipV6PublicIp="tor-bridge-ipV6-public-ip-address-$randomIdentifier"
